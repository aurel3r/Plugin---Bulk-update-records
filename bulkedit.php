...
//				}
		...
		<h2>
			<?php _e( 'WooCommerce Bulk Edit', 'woocommerce-advbulkedit');?>
			<span class="version">(v<?php echo WCABE_VERSION; ?>)</span>
			<span class="top-help-links">
				<a href="<?php echo home_url().'/wp-admin/edit.php?post_type=product&page=advanced_bulk_edit&section=wcabe_settings'; ?>"></a>
			</span>
		</h2>
		<?php
